/**
 * TypeScript port of the Rust github-scan daemon's notification poller
 ...
 * `~/.first-tree/github-scan/inbox.json` under the TS daemon backend. Broker, HTTP, and
 ...
 *   - `poll.ts` is the one-shot CLI (`github-scan poll`) that
...
export interface PollerOptions {
  ...
  gh?: GhClient;
  /** Filesystem layout. Production code passes `resolveGitHubScanPaths()`. */
