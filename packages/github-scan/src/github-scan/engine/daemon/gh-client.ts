...
export class GhClient {
  ...
  async writeTaskSnapshot(
    ...
    const summaryLines = [
      ...
      ...(this.treeRepo ? [`tree_repo=${this.treeRepo}`] : []),
    ];
    ...
    if (prNumber !== undefined) {
      ...
      // check in snapshot mode. Without it, a github-scan-runner retry (network
...
function renderSnapshotReadme(
  ...
  return (
    ...
    "\n" +
    "If you still need `gh`, github-scan-runner will broker and pace the command automatically.\n" +
    "\n" +
