/**
 * Contract tests for the Phase 3b TypeScript port of the github-scan daemon
 * HTTP + SSE server.
 *
...
function makeCtx(): Ctx {
  const dir = mkdtempSync(join(tmpdir(), "github-scan-http-"));
  return {
    dir,
      ...
      tasksProvider: () => [
        {
          task_id: "task-1",
          status: "simulated",
          repo: "bingran-you/github-scan",
          workspace_repo: "bingran-you/github-scan",
          thread_key: "/repos/bingran-you/github-scan/issues/1",
          title: "probe",
          kind: "mention",
