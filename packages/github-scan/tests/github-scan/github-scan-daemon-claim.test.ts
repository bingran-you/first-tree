...
import {
  ...
  releaseClaim,
  tryClaim,
} from "../../src/github-scan/engine/daemon/claim.js";
import type { DaemonIdentity } from "../../src/github-scan/engine/daemon/identity.js";

function mkScratch(prefix: string): string {
  return mkdtempSync(join(tmpdir(), `github-scan-claim-${prefix}-`));
}
