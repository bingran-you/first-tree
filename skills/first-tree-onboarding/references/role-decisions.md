...
| `tree-repo`              | Current dir is the tree repo itself (`NODE.md` + `.first-tree/tree.json`).                             | Stop. Ask the user whether they meant to onboard a source repo. Do not run onboarding inside the tree.                                                                                                          |
