...
| ---------------------------------- | ------------------------------------- | ---------------------------------------------------------------- |
| `first-tree breeze <subcommand>`   | `first-tree github scan <subcommand>` | public rename; implementation currently lives in `packages/auto` |
| `first-tree skill <subcommand>`    | `first-tree tree skill <subcommand>`  | skill maintenance moves under the tree namespace                 |
| `first-tree gardener <subcommand>` | `skills/gardener/`                    | gardener is no longer a top-level CLI product                    |
...
| `github scan ...`              | implemented by wiring the public CLI to `packages/auto`                  |
| `hub ...`                      | stub namespace only                                                      |
| `skills/gardener/`             | planned, not yet present in this workspace                               |
...
3. deliver `skills/gardener/` as the proposal's integration-skill replacement
